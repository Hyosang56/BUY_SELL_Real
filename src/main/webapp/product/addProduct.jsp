 		...
 		<div class="text-center">
			<div class="contentmain">
				<main class="form-add-out">
       				<h3>상품 등록해주세요.</h3>
    				<form class="form-add-in" name="newProduct" action="./processAddProduct.jsp" method="post" enctype="multipart/form-data">
	    			<div class="form-floating">
	    				<input type="text" class="form-control" name="name" size = "30" placeholder="name" maxlength="15" required>
	    				<label for="floatingInput">상품 이름(글자수 15자 제한)</label>
	    			</div>
	    			<div class="form-floating">
